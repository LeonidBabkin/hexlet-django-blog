...
SECRET_KEY = 'django-insecure-%#2dtg+r-h^sr5v6f)avrs#h6e8np*0ib_vic@v^af@2ici4(o'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates', 'articles': '/hexlet-django-blog/hexlet_django_blog/templates/articles'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
